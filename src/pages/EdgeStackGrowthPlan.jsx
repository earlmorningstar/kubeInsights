    ...
    return (
      <div className="demoSchedule-parent">
        <div className="demoSchedule-firstSection">
          <h1>Edge Stack Growth Plan</h1>
          <p>Get started with the simplest API Gateway for fast, flexible deployment.</p>
          <div className="contactFor">
            <p>Get access to a FREE Growth Plan trial including:</p>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> Unlimited Clusters and Instances
            </span>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> 5 Million RPM, included (with additional available)
            </span>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> Web Application Firewall (WAF)
            </span>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> SSO
            </span>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> Comprehensive Authentication (OAuth, JWT, SAML, OpenID Connect)
            </span>
            <span>
              <GiCheckMark color="#6852f8" size={20} /> Standard Support Plan
            </span>
          </div>
...
export default EdgeStackGrowthPlan;